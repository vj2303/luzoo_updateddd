...
const BuyGiftcard = () => {
    ...
    return (
        <div className="sm:px-[120px] px-[10px] py-[60px]">
            ...
            <p className="text-[#051036] leading-[24px] font-medium text-[16px] mt-[10px] ">The gift card is valid for 1 year and can be used to pay at 500+ salons, spas & dermatologists across Mumbai, Pune & Bengaluru with the LUZO app.</p>
